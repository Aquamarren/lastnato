 ...
 */
public class GoalForecast extends Activity{
    DatabaseHelper mydb;
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.goal_forecast);
        openDatabase();
        ...
        textViewGoalRank = (TextView)findViewById(R.id.textViewGoalRank_);
    ...
    public void showGoalDetails() {
        ...
        if(Float.valueOf(savingsAmount) > Float.valueOf(textGoalCost)){ //error here
            textViewGoalDateForecast.setText("You can achieve it today");
        }else {
            float numberOfMonths = Float.valueOf(textGoalCost) / Float.valueOf(savingsAmount);
                    ...
                    try {
                        ...
                        if (dateWantToAchieveMs >= currentDate) {
                            ...
                            */
                            ...
                            Toast.makeText(GoalForecast.this, "Date should be greater than current date", Toast.LENGTH_LONG).show();
                        }
